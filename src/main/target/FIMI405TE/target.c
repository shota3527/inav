...
//With INAV firmware, DSHOT can not work on S3, S5,S7 because of DMA clash,  pls use ONESHOT or MULTISHOT and calibrate ESC PWM range.<-copied from matek website
    DEF_TIM(TIM8,  CH4,  PC9,  TIM_USE_VTOL_SERVO,   0, 0), // S1 D(2,7,7) UP217
    DEF_TIM(TIM8,  CH3,  PC8,  TIM_USE_VTOL_SERVO,   0, 0), // S2 D(2,2,0) UP217
    DEF_TIM(TIM1,  CH3N, PB15, TIM_USE_VTOL_SERVO,   0, 0), // S3 D(2,6,0) UP256
    DEF_TIM(TIM1,  CH1,  PA8,  TIM_USE_VTOL_SERVO,   0, 1), // S4 D(2,1,6) UP256

    DEF_TIM(TIM2,  CH4,  PB11, TIM_USE_VTOL_MOTOR,   0, 0), // S5 D(1,7,3) UP173
    DEF_TIM(TIM2,  CH3,  PB10, TIM_USE_VTOL_MOTOR,   0, 0), // S6 D(1,1,3) UP173
    DEF_TIM(TIM2,  CH2,  PB3,  TIM_USE_VTOL_MOTOR,   0, 0), // S7 D(1,6,3) UP173
    DEF_TIM(TIM2,  CH1,  PA15, TIM_USE_VTOL_MOTOR,   0, 0), // S8 D(1,5,3) UP173
